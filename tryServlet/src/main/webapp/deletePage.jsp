...
<body>
	...
	<form action=http://localhost:8081/tryServlet/SimpleServlet
		...
		<fieldset>
			...
			Choose a show to delete: 
			<input type="submit" value="See Shows!" name="seeShowsDelBtn"> <br>
			<% if (selectionText != null){ %>
				<%=selectionText%>
				<%}%><br> 
			<input type="submit" value="Purge Show" name="purgeShowBtn">
			<%	String title = (String) request.getAttribute("title"); %>
				<%if (title != null) {%>
				<br><%=title %> has been successfully purged.
				<input type="submit" value="Undo?" name="unpurgeShowBtn">
				<%}%>

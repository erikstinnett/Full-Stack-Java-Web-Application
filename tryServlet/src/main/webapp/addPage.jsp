...
<body>
	...
	<form action=http://localhost:8081/tryServlet/SimpleServlet
		method="get">
		<fieldset>
			Add a show: <input type="text" name="addShowTxt" class = "txtClass"/> <br> 
			<input type="submit" id="btn" name="submitShowBtn" value="Add Show" /> 
			<label for="btn">Format for entry:<br> 
				2022-09-04,Films (English),1,Me Time,N/A,56560000,2 </label>
			<%
			String show = (String) request.getAttribute("getShow");
			%>
			<% if (show != null){ %>
			<br>
			<br>Added show :
